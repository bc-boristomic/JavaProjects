package ba.bitcamp.homeworkclasses16.task4;
...
/**
 * Task4 class have one inner class used to set up JPanel, and one anonymous
 * class used to implement KeyAdaper abstract class responsible for reacting to
 * keyboard buttons. You can move black circle by pressing up, down, left, right
 * on you keyboard.
 * 
 * @author boris
 *
...
public class Task4 extends JFrame {
	...
	/**
	 * Constructor of Task4 class, set's up JFrame, JPanel and KeyAdapter as
	 * Anonymous class
	 */
	public Task4() {
		...
		/**
		 * Anonymous class KeyAdapter and uses only one method keyPressed to
		 * check which key is pressed and to direct movement of circle from in
		 * every which way user inputed. Other methods are not implemented
